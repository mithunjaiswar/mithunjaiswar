...
| Monthly Dashboard | Month by month (Lakshya months) for India or a picked city, Lakshya plan vs our plan (books, on road, placements), live insights, and city tables: on road vs Lakshya, net add, placements, churn, utilisation, Lakshya vs plan placements and fleet |
