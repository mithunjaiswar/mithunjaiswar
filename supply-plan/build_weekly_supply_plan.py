...
def build_city(wb, idx, city):
    ...
    notes = [
        ...
        "SEASONALITY (BE:BF): festival impact on recruitment for the event in that week (Inputs A6 and B1); seasonality factor = 1 + impact, floored. Weeks with no festival have a factor of 1.",
